...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots;
      var t = input.files[0].name.split('.');
      t[0].length > 6 ? dots = "..." : dots = ".";
      var name = t[0].substring(0, 6) + dots + t[1];
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      console.log(api);
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData) // Sending data from formData
      .then(function (res) {
        console.log(res);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); // btn.addEventListener("click", function () { // For db json-server src/assets/db.json
